...
//     document.write(`<div class="name">${users[i].name}</div>`)
// }
...
//
// for (let i = 0; i < users.length - 1; i++) {
//     document.write(`<div class="name">${i}
// ${users[i].name}
// </>`)}
...
//
// let i = 0
// while (i < locations.length - 5)
// {
//     let location = locations[i]
//     document.write(`<h1>${location.title}</h1>`)
//     i++
// }
...
// {
//     let location = locations[i]
//     document.write(`<h1>${i} ${location.title}</h1>`)
//     i++
// }
